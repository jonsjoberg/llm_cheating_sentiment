...
export const getAllSentimentsPerApp = async (
	...
	const positive = getReviewsPerAppAndSentiment(db, app, ReviewSentiment.Positive);
	const negative = getReviewsPerAppAndSentiment(db, app, ReviewSentiment.Negative);
	const notMentioned = getReviewsPerAppAndSentiment(db, app, ReviewSentiment.NotMentioned);
...
export const getReviewsPerAppAndSentiment = async (
	...
	const reviewsWithSentiment = reviewsRef.where('sentiment', '==', sentiment);
